...
public class JFListarClientes extends JFrame {
	...
	public JFListarClientes() {
		...
		scrollPane.setBounds(10, 11, 623, 280);
		...
		JButton btnCadastrar = new JButton("Cadastrar um Cliente");
		...
		btnCadastrar.setBounds(10, 322, 175, 30);
		contentPane.add(btnCadastrar);
		
		JButton btnAlterar = new JButton("Alterar um Cliente");
		...
		btnAlterar.setBounds(190, 322, 141, 30);
		contentPane.add(btnAlterar);
		
		btnExcluir = new JButton("Excluir um Cliente");
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(jtCliente.getSelectedRow() != -1) {	
					
				int opcao = JOptionPane.showConfirmDialog(null, "Deseja excluir este cliente?", "Exclusão", JOptionPane.YES_NO_OPTION);		
				if(opcao == 0) {
		...
		btnExcluir.setBounds(336, 322, 141, 30);
		...
		btnCancelar.setBounds(482, 322, 91, 30);
